...
class Kn:
    ...
    def draw(self):
        ...
        self.chargebox = pygame.Rect(self.x, self.y - 30, self.jump_charge * 2.5, 10)
        pygame.draw.rect(screen, (0, 0, 255), self.chargebox)

        screen.blit(Kn_Body, (self.x + 13, self.y))
...
Kn_Invinc = get_image(sprite_Kn_Invinc, 0, 70, 100, 1, WHITE)
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_ESCAPE:
                ...
                while menu_open:
                    ...
                    pygame.draw.rect(screen, (50, 50, 255), (50, 50, SCR_WIDTH - 100, SCR_HEIGHT - 100), 20)
